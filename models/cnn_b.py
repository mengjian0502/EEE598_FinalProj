...
class Net(nn.Module):
    def __init__(self, num_class=10):
        ...
        self.conv1 = BinaryConv2d(in_channels=1, out_channels=24, 
        ...
        self.conv2 = BinaryConv2d(in_channels=24, out_channels=32, 
                            kernel_size=3, stride=1)
        self.bn2 = nn.BatchNorm2d(32)
        self.relu2 = TerneryHardTanh(inplace=False)

        self.fc1 = BinaryLinear(in_features=512, out_features=num_class)
